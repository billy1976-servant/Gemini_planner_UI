...
create table public.projects (
  ...
  constraint project_unique_per_module unique (module_id, project_name),
  constraint projects_module_id_fkey foreign KEY (module_id) references modules (module_id)
) TABLESPACE pg_default;

...
**Classification:** FOUNDATIONAL — Entry point; primary architecture reference: `src/docs/ARCHITECTURE_AUTOGEN/`, `src/docs/SYSTEM_MAP_AUTOGEN/`.
...
Then open **src/docs/SYSTEM_MAP_AUTOGEN/** and read **START_HERE.md** (this file), **ENGINE_INDEX.md**, and **RUNTIME_PIPELINE.md**; for plans see **src/cursor/** and root-level plan docs.

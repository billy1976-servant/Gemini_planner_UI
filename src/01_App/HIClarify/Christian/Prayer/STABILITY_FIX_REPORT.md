...
|----------|----------|--------|--------|
| `PrayerRoom.tsx` | `ROOM_POLL_MS` | 5000 ms | OK (≥ 5000) |
| `room/usePrayerRoomSignaling.ts` | `SIGNALING_POLL_MS` | 5000 ms | OK (≥ 5000) |
| `room/ActiveRoomsContext.tsx` | `ACTIVE_POLL_MS` | 10000 ms | OK (≥ 5000) |
| `PrayerApp.tsx` | `LIVE_POLL_INTERVAL_MS` | 20000 ms | OK (≥ 5000) |

No polling under 3000 ms remains. Room and signaling polling are both ≥ 5000 ms.

  ...
  return (
    ...
    >
      ...
      >
        ...
        {loading && <p style={{ fontSize: "0.875rem", color: "var(--prayer-text-muted)" }}>Loading…</p>}
        {error && <p style={{ fontSize: "0.875rem", color: "#f87171" }}>{error}</p>}
        {!loading && !error && drafts.length === 0 && (
          <p style={{ fontSize: "0.875rem", color: "var(--prayer-text-muted)" }}>No snapshots yet. Record and use “Save snapshot” to add one.</p>
        )}

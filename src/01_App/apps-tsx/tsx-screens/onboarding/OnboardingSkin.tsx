...
export default function OnboardingSkin() {
  const engine = OnboardingEngine() as unknown as {
    state: { answers: Array<{ good: boolean; text: string }>; step: number; events: Array<{ event: string; at: number }> };
    activeQuestion: { prompt: string } | null;

    ...
    <div className="prayer-live-section" style={{ marginTop: "1rem" }}>
      ...
      >
        ...
        >
          ...
          >
            {creating === "room" ? "CreatingΓÇª" : "Start Live Room"}
          </button>
          <button
            type="button"
            disabled={isCreating}
          ...
          >
            {creating === "1on1" ? "CreatingΓÇª" : "Start 1-on-1 Prayer"}
          </button>
          <button
            type="button"
            disabled={isCreating}
          ...
          >
            {linkCopied ? "Link copied" : creating === "link" ? "CreatingΓÇª" : "Create Private Link"}
          </button>
        </div>
        {error && (
      ...
      {loading ? (
        <p className="prayer-section-muted">Loading roomsΓÇª</p>

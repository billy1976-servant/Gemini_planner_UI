...
const CO_LOCATED_MAP: Record<string, ConventionResult> = {
  ...
  "ContainerCreations/Learn/landing/ContainerCreationsLanding": { structureType: "wizard", templateId: "default", overrides: {} },
  "ContainerCreations/Learn/landing/ContainerCreationsLanding-2": { structureType: "wizard", templateId: "default", overrides: {} },
  ...
  // Prayer app (player + room + platform)
  "Christian/Prayer/PrayerApp": { structureType: "list", templateId: "default", overrides: {} },
  // Prayer live room (dashboard: toolbar + content + moderator panel)
  "Christian/Prayer/PrayerRoom": { structureType: "dashboard", templateId: "default", overrides: {} },
};

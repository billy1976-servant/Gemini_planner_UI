...
/**
 * TSX screen registry — auto-loads all screens under src/01_App/Business/** and
 * Runtime/FlowRuntimeScreen. Provides getComponent with path normalization,
 * logging (REQUESTED / AVAILABLE), and closest-match suggestion when not found.
 */
...
// Alias: flow JSON name → FlowRuntimeScreen

...
import {
  ...
  structureConfirmStaging,
  structureSetTaskFolderTemplate,
  structureSetTaskTemplateRows,
  structureSetParserConfig,
  structureLoadRuleset,
...
const registry: Record<string, ActionHandler> = {
  ...
  "structure:confirmStaging": structureConfirmStaging,
  "structure:setTaskFolderTemplate": structureSetTaskFolderTemplate,
  "structure:setTaskTemplateRows": structureSetTaskTemplateRows,
  "structure:setParserConfig": structureSetParserConfig,
  "structure:loadRuleset": structureLoadRuleset,

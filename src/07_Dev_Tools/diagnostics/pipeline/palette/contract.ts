/**
 * Palette contract validation — canonical implementation for pipeline diagnostics.
 * Re-exported from diagnostics/paletteContractCheck.ts for backward compatibility.
 */

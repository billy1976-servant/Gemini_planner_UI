...
import Cleanup25xDemo from "@/screens/tsx-screens/calculators/calculator-1";
import EducationFlow from "@/screens/tsx-screens/calculators/Education-flow";


/* ======================================================
   TYPES — WRAPPER OWNS SHAPE ONLY (UNCHANGED)
====================================================== */
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", width: "100%" }}>
        ...
        {/* ======================================================
            PERSISTENT CHOOSER CARDS  (UI CHANGE — SAFE)
        ====================================================== */}
        <div style={{ marginBottom: 32 }}>
          ...
          >
            <ChoiceCard
              active={session.flow === "calculator"}
            ...
            <ChoiceCard
              active={session.flow === "education"}
              title="Why This Is Costing You"
              body="Learn how cleanup affects safety, trust, bids, and closeouts."
...
function ChoiceCard({
  ...
  return (
    ...
    >
      ...
      <p style={{ opacity: 0.85, marginTop: 8 }}>{body}</p>
      <div style={{ marginTop: 14, fontWeight: 600 }}>{action}</div>
    </div>
  );
}

...
import { getResearchFactsByIndustry } from "../../../src/logic/research/research-fact-library";
import { getIndustryModel } from "../../../src/logic/value/assumption-library";
 ...
 */
export async function attachResearch(productGraph: ProductGraph): Promise<ResearchBundle> {

...
| Phase | Name | Packets |
|-------|------|---------|
| A | UI Foundation (Visual System First) | 01, 02, 03, 06, 07 |
| B | Layout + Rendering (Make Screens Look Correct) | 08, 09 |
| C | Core Compiler Path (Only What Marketing Needs) | 14, 15, 16, 18 |
| D | Marketing Engine (Primary Goal) | 27, 28, 29, 30 |
| E | Logic Pipeline (Needed for Interactions) | 10, 11, 12, 13 |
| F | Later Systems (Do Not Block Marketing) | Journal 19–22; Planner 23–26; Migration 31–34 |

---

## PHASE A — UI FOUNDATION (Visual System First)

Get the visual system and molecule UI locked so all JSON screens render correctly and shells/profiles are distinct.
...
## PHASE B — LAYOUT + RENDERING (Make Screens Look Correct)

Ensure section IDs and skin proof path are correct so screens and viewer filter work.
...
## PHASE C — CORE COMPILER PATH (Only What Marketing Needs)

Document and wire the single compiler path and product→skin path; keep scope to what marketing pages need.
...
## PHASE D — MARKETING ENGINE (PRIMARY GOAL)

Deliver working marketing/product pages via skin JSON → SiteSkin → JsonRenderer.
...
## PHASE E — LOGIC PIPELINE (Needed for Interactions)

Wire JSON behavior and validation so interactions work without blocking marketing delivery.
...
## PHASE F — LATER SYSTEMS (Do Not Block Marketing)

Journal, Planner, and Migration run after the marketing engine is delivered.

---

### Journal (Packets 19–22)
